...
public partial class MainWindowViewModel : ViewModelBase, IDisposable
{
    ...
    private async Task StartDownloadAsync()
    {
        ...
        {
            DestinationRoot = SelectedProfile?.Path ?? _settingsViewModel.DestinationRoot,
            MaxParallelism = _settingsViewModel.MaxParallelism,
            VerifyAfterCopy = _settingsViewModel.VerifyAfterCopy,
            BackupDestinations = BackupDestinationBuilder.FromPaths(
                _settingsViewModel.BackupPath1,
                _settingsViewModel.BackupPath2),
        };
